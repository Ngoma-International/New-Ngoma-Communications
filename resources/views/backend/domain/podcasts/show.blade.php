                ...
                <div class="card-inner">
                    ...
                    <div class="nk-block">
                        ...
                        @if($postViewModel->getTypePodcast() === 1)
                            <div class="col-lg-5 justify-content-center">
                                <div class="video text-center">
                                    <audio controls>
                                        <source src="{{ asset('storage/'.$postViewModel->podcast->images_video) }}" type="audio/ogg">
                                        <source src="{{ asset('storage/'.$postViewModel->podcast->images_video) }}" type="audio/mpeg">
                                    </audio>
                                </div>
                            </div>
                        ...
                        @else
                            <div class="col-lg-5 justify-content-center">
                                <div class="video text-center">
                                    <video width="320" height="260" controls poster="{{ asset('storage/'.$postViewModel->podcast->thumbnail) }}">
                                        <source src="{{ asset('storage/'.$postViewModel->podcast->images_video) }}" type="video/mp4">
                                        <source src="{{ asset('storage/'.$postViewModel->podcast->images_video) }}" type="video/ogg">
                                    </video>
                                </div>
                            </div>
                        @endif
