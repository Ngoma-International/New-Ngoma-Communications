                        ...
                        <div class="profile-ud-list">
                            <div class="profile-ud-item">
                                <div class="profile-ud wider">
                                    ...
                                    <span
                                        class="profile-ud-value">{{ ucfirst($viewModels->seminar->name) ?? "" }}</span>
                                </div>
                            </div>
                            <div class="profile-ud-item">
                                <div class="profile-ud wider">
                                    ...
                                    <span
                                        class="profile-ud-value">{{ ucfirst($viewModels->getAuthor()->name) ?? "" }}</span>
                                </div>
                            </div>
                            <div class="profile-ud-item">
                                <div class="profile-ud wider">
                                    ...
                                    <span
                                        class="profile-ud-value">{{ $viewModels->getAuthor()->firstname ?? "" }}</span>
                                </div>
                            </div>
                            <div class="profile-ud-item">
                                <div class="profile-ud wider">
                                    ...
                                    <span
                                        class="profile-ud-value">{{ ucfirst($viewModels->getCategory()->name) ?? "" }}</span>
                                </div>
                            </div>
                            <div class="profile-ud-item">
                                <div class="profile-ud wider">
                                    ...
                                    <span
                                        class="profile-ud-value">{{ ucfirst($viewModels->getSeminarType()->name) ?? "" }}</span>
                                </div>
                            </div>
                            <div class="profile-ud-item">
                                <div class="profile-ud wider">
                        ...
                        <div class="profile-ud-list">
                            <div class="profile-ud-item">
                                <div class="profile-ud wider">
                                    ...
                                    <span
                                        class="profile-ud-value">{{ $viewModels->seminar->created_at->format('Y-m-d') }}
                                    </span>
                                </div>
                            </div>
                            <div class="profile-ud-item">
                                <div class="profile-ud wider">
                                    ...
                                    <span
                                        class="profile-ud-value">{{ $viewModels->seminar->updated_at->format('Y-m-d') }}
                                    </span>
                                </div>
                            </div>
                            <div class="profile-ud-item">
