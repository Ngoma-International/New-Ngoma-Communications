<form action="{{ route('admins.seminar.update', $viewModels->seminar->id) }}" method="post" class="form-validate mt-2"
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input
                            ...
                            id="name"
                            name="name"
                            value="{{ old('name') ?? $viewModels->seminar->name }}"
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input
                            ...
                            id="city"
                            name="city"
                            value="{{ old('city') ?? $viewModels->seminar->city }}"
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input
                            ...
                            id="start_time"
                            name="start_time"
                            value="{{ old('start_time')  ?? $viewModels->seminar->start_time }}"
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input
                            ...
                            id="end_time"
                            name="end_time"
                            value="{{ old('end_time')  ?? $viewModels->seminar->end_time }}"
            ...
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <input
                            ...
                            value="{{ old('address_seminary')  ?? $viewModels->seminar->address_seminary }}"
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    ...
                    >{{ old('attend') ?? $viewModels->seminar->attend }}</textarea>
                </div>
            </div>
        </div>
