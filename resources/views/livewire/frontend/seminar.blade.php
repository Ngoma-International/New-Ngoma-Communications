            ...
            <div class="box-item card-box">
                ...
                <div class="desc">
                    <div style="display: flex; justify-content: space-between; align-items: center">
                        <a href="{{ route('seminar.show', $seminar->id) }}" class="name">
                            {{ ucfirst($seminar->title) ?? "" }}
                        </a>
                        <span style="color: white; font-weight: bold; font-family: Roboto,sans-serif, Arial">
                            $ {{ $seminar->prices ?? 0 }}
                        </span>
                    </div>
                    <div class="category" style="color: whitesmoke; margin-top: 1rem;">
                        {{ ucfirst($seminar->address->city) ?? "" }}
                    </div>
                </div>
            </div>
        </div>
