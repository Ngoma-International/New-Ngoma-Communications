        ...
        <div class="row">
            ...
            <div class="col col-m-12 col-t-12 col-d-6 col-d-lg-4">
                <div class="box-item card-box ">
                    ...
                    <div class="desc">
                        <a href="#popup-leadSelf" class=" has-popup-media link" style="font-weight: 500; font-size:20px; text-align: center; justify-content: center; justify-items: center; border-bottom:none !important; cursor: pointer;">
                            <i class="far fa-compass" style="background-color: red; color:white; height: 20%;"></i>
                            <br>
                            <span style="font-size: 12px; color: #fff; text-align: center">Leading Yourself</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col col-m-12 col-t-12 col-d-6 col-d-lg-4">
                <div class="box-item card-box">
                    ...
                    <div class="desc">
                        <a href="#popup-leadOthers" class=" has-popup-media link" style="font-weight: 500; font-size:20px; text-align: center; border-bottom:none !important; cursor: pointer;">
                            <i class="far fa-compass" style="background-color: blue; color:white; height: 10%;"></i>
                            <br>
                            <span style="font-size: 12px; color: #fff; text-align: center">Leading People</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col col-m-12 col-t-12 col-d-7 col-d-lg-4 card3" id="card3" style="">
                <div class="box-item card-box">
                    ...
                    <div class="desc">
                        <a href="#popup-leadBusiness" class="has-popup-media link" style="font-weight: 500; font-size:20px; justify-items: center; border-bottom:none !important; cursor: pointer;">
                            <i class="far fa-compass" style="background-color: #4caf50; color:white;"></i>
                            <span style="font-size: 12px; color: #fff;  text-align: center; white-space: nowrap">
