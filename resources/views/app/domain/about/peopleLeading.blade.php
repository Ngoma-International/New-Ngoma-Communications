    ...
    <div class="card-inner active" id="blog-card">
        <div class="row card-container">
            <div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-6" data-simplebar>
                <div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url(images/bg1.jpg); padding-right: 0px;">
                ...
                <div class="content inner-top">
                    <div class="row">
                        <div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
                            <div class="title-bg" style="font-size: 60px;">Leading People</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
                            <div class="post-box card-box">
                                ...
                                <div class="blog-content">
                                    ...
                                    <p>Please refer to this <i class="far fa-compass" style="background-color: red; border-radius: 50px;  color:white;" aria-hidden="true"></i>  icon when searching fro Leading Yourself events.</p>
