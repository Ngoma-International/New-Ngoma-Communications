    ...
    <div class="card-inner" id="about">
        <div class="row card-container">
            <div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-7">
                <div class="card-image card-image1 col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url({{ asset('assets/images/ngoma.jpg') }}); background-size: cover;  overflow-y: scroll;">

                    <p class="mobile4">We maintain a pool of highly qualified facilitators, coaches, and
                        ...
                        leadership: Leading Youself; Leading People; Leading Organisations. </p>
                    <div class="row">
                            ...
                            <div class="box-item card-box ">
                                ...
                                <div class="desc">
                                    <a href="#popup-leadSelf" class=" has-popup-media link" style="font-weight: 200; font-size:20px; text-align: center; border-bottom:none !important; cursor: pointer;">
                                        <i class="far fa-compass" style="background-color: red; color:white; height: 20%;"></i><br><span style="font-size: 12px; color: #fff; text-align: left;" class="ml">Leading Yourself</span></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="box-item card-box">
                                ...
                                <div class="desc">
                                    <a href="#popup-leadOthers" class=" has-popup-media link" style="font-weight: 200; font-size:20px; text-align: center; border-bottom:none !important; cursor: pointer;">
                                        <i class="far fa-compass" style="background-color: blue; color:white; height: 10%;"></i><br><span style="font-size: 12px; color: #fff; text-align: left;" class="ml">Leading People</span></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12" style="">
                            ...
                            <div style="margin-top: 1rem; margin-bottom: 2rem">
                                ...
                                <a href="events.php" class="btn2" style="height: 30%; font-size: 12px; background-color: #318342; padding: 8px 8px; border-radius: 5px;">Public
                                    Training</a>

                                <a href="in-house.php" class="btn2" style="height: 30%; font-size: 12px; background-color: #318342;padding: 8px 8px; border-radius: 5px;">In-House
                                    Training</a>
                            ...
                            <div class="title-bg mobile1" style="margin-top: 7rem;margin-bottom: 3rem; text-align: left !important">About
                                Us</div>
                            ...
                            <div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12" style="">
                                <div class="aboutButtons" style="text-align:left;">
                                    ...
                                    <a class="btn2" href="about/?ngoma=a" style="background-color: #318342; margin-left: 12rem; font-size: 13px !important;"><span><i></i>Advisory
													Board</span></a>
    ...
    <div class="card-inner" id="sessions">
        <div class="row card-container">
            ...
            <div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-6" data-simplebar>
                ...
                <!-- Offering Image -->
                <div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url({{ asset('assets/images/ngoma.jpg') }});">
    ...
    <div class="card-inner" id="events">
        ...
        <div class="row card-container">
            ...
            <div class="card-wrap col col-m-12 col-t-12 col-d-8 col-d-lg-6" data-simplebar>
                ...
                <!-- Offering Image -->
                <div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style="background-image: url({{ asset('') }});">
