...
@section('title', "Cree un compte pour reserver une salle")
        ...
        <div class="w-full xl:max-w-screen-2xl md:w-5/12 px-4 smallmob:pt-5 sm:px-20 sm:pt-4 md:pt-0 md:p-0 z-50">
            <div class="z-100 w-full">
                <div class="w-full grid gap-8 bg-white p-1  py-5 rounded-lg sm:p-10 md:pl-10 lg:pl-24 md:p-10 ">
                    ...
                    @include('frontend.shared._alert')
                    ...
                    <form method="POST" action="{{ route('register') }}" class="grid gap-8  w-full">
                        ...
                        <div class="grid gap-5">
                            ...
                            <div class="grid gap-2">
                                <label for="username" class="text-base font-normal text-gray-600">Nom utilisateur</label>
                                <input
                                    type="text"
                                    id="username"
                            ...
                            <div class="grid gap-2">
                                <label for="phones_number" class="text-base font-normal text-gray-600">Numero telephone</label>
                                <input
                                    type="text"
                                    id="phones_number"
                            ...
                            <div class="grid gap-2">
                                <label for="password-confirm" class="text-base font-normal text-gray-600">Confirmer mot de passe</label>
                                <input
                                    type="password"
                                    id="password-confirm"
                                    placeholder="Enter your password"
                        ...
                        <div>
                            <button class="w-full px-5 py-3 rounded-lg bg-green-600 text-white transition-all duration-300 hover:bg-green-700">S'inscrire</button>
                        </div>
                    </form>
                    <div>
