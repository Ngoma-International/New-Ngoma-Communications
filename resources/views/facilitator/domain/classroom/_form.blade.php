<form action="{{ route('admins.class-room.store') }}" method="post" class="form-validate mt-2">
    @csrf
    <div class="row g-gs">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <select
                        class="form-control js-select2 select2-hidden-accessible @error('event') error @enderror"
                        id="event"
                        data-search="on"
                        name="event"
                        data-placeholder="Select a event"
                        required>
