<form action="{{ route('admins.seminary.update', $seminar->id) }}" method="post" class="form-validate mt-2" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row g-gs">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="form-label" for="name">Name seminar</label>
                <div class="form-control-wrap">
                    <input
                        type="text"
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label class="form-label" for="images">Seminar Poster</label>
                <div class="form-control-wrap">
                    <input
                        type="file"
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="form-control-wrap">
                    <textarea
                        class="form-control form-control-sm @error('outline') error @enderror"
                        id="outline"
                        name="outline"
                        rows="2"
                        placeholder="Write the outline"
                    >{{ old('outline') }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label class="form-label" for="type">Facilitator</label>
                <div class="form-control-wrap">
                    <select
                        class="form-control js-select2 select2-hidden-accessible @error('type') error @enderror"
                        id="type"
