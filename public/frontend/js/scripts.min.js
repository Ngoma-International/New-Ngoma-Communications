! function(t, e) {
        ...
        c.extend(c.fn, {
            ...
            prototype: {
                ...
                elementValue: function(t) {
                    var e, n, i = c(t),
                        r = t.type;
                    return "radio" === r || "checkbox" === r ? this.findByName(t.name).filter(":checked").val() : "number" === r && void 0 !== t.validity ? t.validity.badInput ? "NaN" : i.val() : (e = t.hasAttribute("contenteditable") ? i.text() : i.val(), "file" === r ? "C:\\fakepath\\" === e.substr(0, 12) ? e.substr(12) : 0 <= (n = e.lastIndexOf("https://beshley.com/")) ? e.substr(n + 1) : 0 <= (n = e.lastIndexOf("\\")) ? e.substr(n + 1) : e : "string" == typeof e ? e.replace(/\r/g, "") : e)
                },
                check: function(e) {
    ...
    $("#home").length && $(".top-menu").on("click", "a", function() {
        var t = $(".lines-grid"),
            e = $(this).attr("href"),
            n = $(".card-inner"),
            i = $(e),
            r = $(".top-menu li"),
            o = $(this).closest("li");
        return !o.hasClass("active") & $("#home").length && (r.removeClass("active"), t.removeClass("loaded"), o.addClass("active"), setTimeout(function() {
    ...
    n.imagesLoaded(function() {
        ...
        return $("#home").length || (location.href = "/patrick/" + $(this).attr("href")), !1
    });
    var i = location.hash,
        r = $(i);
