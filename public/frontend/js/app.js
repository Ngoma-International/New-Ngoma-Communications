...
"use strict";
__webpack_require__.r(__webpack_exports__);
Object(function webpackMissingModule() { var e = new Error("Cannot find module './frontend/js/scripts'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _Shared_util_toastr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Shared/util/toastr */ "./resources/js/Shared/util/toastr.js");
...
window.addEventListener('booking-store', function (_ref) {
  var _ref$event = _ref.event,
      type = _ref$event.type,
      message = _ref$event.message;
  (0,_Shared_util_toastr__WEBPACK_IMPORTED_MODULE_1__.toast)(type, message);
});
