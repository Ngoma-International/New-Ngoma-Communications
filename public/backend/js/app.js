...
/***/ "./resources/js/Shared/util/dom.js":
/*!*****************************************!*\
  !*** ./resources/js/Shared/util/dom.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createButtonLoader": () => (/* binding */ createButtonLoader),
/* harmony export */   "removeButtonLoader": () => (/* binding */ removeButtonLoader),
/* harmony export */   "removeClassByPrefix": () => (/* binding */ removeClassByPrefix)
/* harmony export */ });
/**
...
var createButtonLoader = function createButtonLoader(element) {
  var loadingText = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'chargement...';
  ...
  if (icon) {
    removeClassByPrefix(icon, 'ni-', 'ni-loader').setAttribute('aria-label', 'loader');
  } else {
    element.innerHTML = "\n            <em class=\"icon ni ni-loader\" role=\"img\" aria-label=\"loader\"></em>\n            <span>".concat(loadingText, "</span>\n        ");
  }
};
/**
...
var removeButtonLoader = function removeButtonLoader(element, content) {
...
/* harmony import */ var _dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom */ "./resources/js/Shared/util/dom.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, message) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            timer = _args.length > 2 && _args[2] !== undefined ? _args[2] : 1500;
            _context.next = 3;
            return toastSwalMixin.fire({
              icon: true,
              html: message,
              timer: timer
            });
