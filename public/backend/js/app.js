...
/* harmony import */ var _Shared_util_picker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Shared/util/picker */ "./resources/js/Shared/util/picker.js");
/* harmony import */ var _util_seminar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./util/seminar */ "./resources/js/backend/util/seminar.js");
/* harmony import */ var _Shared_util_toastr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Shared/util/toastr */ "./resources/js/Shared/util/toastr.js");
/* harmony import */ var _Shared_util_time_picker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Shared/util/time-picker */ "./resources/js/Shared/util/time-picker.js");
...
if (date_time) {
  Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ../Shared/util/picker */ "./resources/js/Shared/util/picker.js")).then(function (module) {
    return (0,_Shared_util_picker__WEBPACK_IMPORTED_MODULE_3__.picker)(date_time);
  });
}
...
if (start_time) {
  Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ../Shared/util/time-picker */ "./resources/js/Shared/util/time-picker.js")).then(function (module) {
    return (0,_Shared_util_time_picker__WEBPACK_IMPORTED_MODULE_6__.time_picker)(start_time);
  });
}

if (end_time) {
  Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ../Shared/util/time-picker */ "./resources/js/Shared/util/time-picker.js")).then(function (module) {
    return (0,_Shared_util_time_picker__WEBPACK_IMPORTED_MODULE_6__.time_picker)(end_time);
  });
}
...
if (images) {
  Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./util/seminar */ "./resources/js/backend/util/seminar.js")).then(function (module) {
    return (0,_util_seminar__WEBPACK_IMPORTED_MODULE_4__.uploadImages)(images);
  });
}

window.addEventListener('backend', function (event) {
  (0,_Shared_util_toastr__WEBPACK_IMPORTED_MODULE_5__.toast)(event.detail.type, event.detail.message);
});
})();
